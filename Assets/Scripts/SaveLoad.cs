	...
	public void LoadGame()
	{
		...
		if(currentLine != "###Grass###") //if next category reached, skip
		{
			...
			case "Academy":			
				...
				existingBuildings.GetValueOrInitAndIncrement(currentBuilding[0]);//a local array that holds how many buildings of each type
			break;
			...
			case "Barrel":
				...
				existingBuildings.GetValueOrInitAndIncrement(currentBuilding[0]);
				break;
		...
		while (currentLine != "###BuildingIndex###") //Construction
		{
			...
			if (currentLine != "###BuildingIndex###") 
			{
				...
				case "Academy":					
				    ...
				    existingBuildings.GetValueOrInitAndIncrement(currentConstruction[0]);
				break;
